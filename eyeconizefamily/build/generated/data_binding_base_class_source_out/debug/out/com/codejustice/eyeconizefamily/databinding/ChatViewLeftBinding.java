...
public final class ChatViewLeftBinding implements ViewBinding {
  @NonNull
  ...
  private ChatViewLeftBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ChatViewLeftBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ChatViewLeftBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.chat_view_left, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ChatViewLeftBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ChatViewLeftBinding((ConstraintLayout) rootView, chatProfilePic, messageContent);
    }
